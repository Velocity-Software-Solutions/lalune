...
<div x-show="$store.ui.sidebarOpen" x-transition.opacity class="fixed inset-0 z-30 bg-black/30 md:hidden"
    @click="$store.ui.closeSidebar()" aria-hidden="true">
</div>
        ...
        <ul class="list-none space-y-3 dark:text-[#ffffff] text-lg">
            <li>
                ...
                <ul class="py-1 space-y-1 dropdown">
                    ...
                    <a href="{{ route('admin.reviews.index') }}" class="w-full">
                        <li
                            class="flex items-center w-full gap-2 p-2 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-500 group">
                            <span
                                class="text-2xl text-gray-400 transition duration-75 material-icons dark:text-gray-600 group-hover:text-gray-900 dark:group-hover:text-white">
                                reviews </span>
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Ratings</span>
                        </li>
                    </a>
                    </a>
                    <a href="{{ route('admin.newsletter.subscribers.index') }}" class="w-full">
                        <li
                            class="flex items-center w-full gap-2 p-2 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-500 group">
                            <span
                                class="text-2xl text-gray-400 transition duration-75 material-icons dark:text-gray-600 group-hover:text-gray-900 dark:group-hover:text-white">
                                mail </span>
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Subscribers</span>
                        </li>
                    </a>
                                            </a>
                  <a href="{{ route('admin.newsletter.campaigns.index') }}" class="w-full">
                <li
                    class="flex items-center w-full gap-2 p-2 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-500 group">
                    <span
                        class="text-2xl text-gray-400 transition duration-75 material-icons dark:text-gray-600 group-hover:text-gray-900 dark:group-hover:text-white">
