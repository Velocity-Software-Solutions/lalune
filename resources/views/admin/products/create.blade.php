   ...
   <style>
    ...
    'colors' => $bootColors,
                ...
                <div class="mt-10">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <button type="button" class="px-3 py-1.5 rounded-md bg-black text-white hover:bg-black/90"
                                @click="const v=promptMoney('Set all discounts'); if(v !== null) setAllDiscounts(v)">Set
                                all Discount</button>
          ...
          text-gray-600 dark:text-gray-300"
             ...
             bg-gradient-to-b from-gray-900 to-black text-white font-medium
             shadow-[0_10px_30px_rgba(0,0,0,0.18)]
             ring-1 ring-black/10
             hover:scale-[1.02] active:scale-[0.99]
             transition-all duration-200 ease-out
             before:absolute before:inset-0 before:rounded-xl
             before:ring-1 before:ring-white/10
             after:absolute after:-inset-[1px] after:rounded-xl
             after:shadow-[0_0_18px_rgba(255,255,255,0.08)]
             overflow-hidden">
                            <span class="material-icons text-[20px] relative z-10">straighten</span>
                            <span class="relative z-10">Import Size Chart</span>
                        </button>
                    </template>
