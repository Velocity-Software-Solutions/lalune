...
@section('content')
    ...
    'productTotalQty' => $productTotalQty ?? 0,
        ...
        ">
                    ...
                    @empty
                        <div
                            class="rounded-lg border border-dashed border-black/10 bg-white p-4 text-center text-gray-600">
                            ...
                            <div>
                                ...
                                <div class="inline-flex items-center gap-1 text-amber-500 select-none">
                                    <template x-for="i in 5" :key="i">
                                        <button type="button" class="p-0.5" @mouseenter="hover=i"
                                            @mouseleave="hover=0" @click="rating=i"
                    ...
                    <div class="w-full max-w-lg rounded-2xl bg-white p-5 shadow-xl ">
                        ...
                        <div class="mt-4 flex items-center justify-end">
                            <button class="px-3 py-2 rounded-md border text-sm"
                                @click="showFullReview=false">Close</button>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div
                    class="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3 border-b border-black/10 pb-8 mx-5">
